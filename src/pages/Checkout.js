      ...
      <div className="checkout-container">
        <div className="billing">
          ...
          <div className="billing-data">
            <InputCheckout 
              ...
              type={'text'}
              placeholder={user.name != null ? `${user.name}` : 'Ingrese su nombre'}
              name={'name'}
            ...
            <InputCheckout 
              ...
              label={'Apellido'}
              type={'text'}
              placeholder={user.name != null ? `${user.lastname}` : 'Ingrese su apellido'}
              name={'lastname'}
              regex={expresiones.nombre}
            />
            <InputCheckout 
            ...
            <InputCheckout 
              ...
              type={'email'}
              placeholder={user.name != null ? `${user.email}` : 'example@example.com'}
              name={'email'}
          ...
          {formError ? <p style={{color: "red"}}>Completa todos los campos antes de enviar la órden</p> : null}
        ...
        <div className="order-resume">
          ...
          <div className="order">
            ...
            {sum != 0 ? <div onClick={handleSubmit}><Button text={'Finalizar compra'} /></div> : <div></div>}
          </div>
        </div>
      <div className={modalSuccess? "modalSuccess-wrapper active" : "modalSuccess-wrapper"}>
