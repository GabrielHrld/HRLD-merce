          ...
          <div className="form-container">
            <form action="" onSubmit={onSubmit}>
              ...
              <div>
                {
                  validForm === false &&
                  <p className="text-error danger"><b>Error:</b> Por favor rellena el formulario correctamente</p>
                }
                {
                  validEmail === false &&
                  <p className="text-error danger"><b>Error:</b> Por favor elegí otra dirección de correo electrónico</p>
                }
              </div>
