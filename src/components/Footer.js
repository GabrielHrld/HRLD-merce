    ...
    <div className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section">
          ...
          <ul className="footer-payship_container">
            <div className="footer_image">
              <img src="https://i.imgur.com/AXx1LrP.png" alt="Visa" />
            </div>
            <div className="footer_image">
              <img src="https://i.imgur.com/7ExrMxF.png" alt="Master Card" />
            </div>
            <div className="footer_image">
              <img src="https://i.imgur.com/fMl9mJM.png" alt="Pago Fácil" />
            </div>
          </ul>
        </div>
        <div className="footer-section">
          ...
          <ul className="footer-deliver_container">
            <div className="footer_image">
              <img src="https://i.imgur.com/QZyc9Nm.png" alt="" />
            </div>
          </ul>
        </div>
        <div className="footer-section">
          ...
          <ul className="footer-contact_container">
            <li>
              {' '}
              <AiOutlinePhone className="footer-contact_icon" /> +54 1112345678
            </li>
            <li>
              <AiOutlineCopyright className="footer-contact_icon" />{' '}
              www.dev-gabriel.tech
            </li>
            <li>
              <GoLocation className="footer-contact_icon" /> Buenos Aires,
              Argentina.
            </li>
          </ul>
        </div>
        <div className="footer-section">
          ...
          <ul className="footer-contact_container">
            <li>
              <AiFillGithub className="footer-contact_icon" /> @HeraldHRLD{' '}
            </li>
          </ul>
        </div>
        <div className="footer-section">
