...
const InputCheckout = ({state, setState, label, type, placeholder, name, regex, validatePass,}) => {
  const onChange = (e) =>{
  ...
  return (
    <p>
      <label
      className={state.valid == null ? 'label' : state.valid ? "label labelValid" : "label labelDanger"}
